...
class PhoneAccessibilityService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        Log.i(TAG, "Accessibility service connected (foreground service will start automatically when screen recording permission is granted)")
    }
    ...
    override fun onDestroy() {
        ...
        // ⚠️ Do NOT stop the foreground service!
        // Foreground service needs to keep running to maintain MediaProjection screen recording permission
        // Only stop when user manually resets permission
        Log.d(TAG, "onDestroy - Accessibility service destroyed (foreground service continues)")
    }
