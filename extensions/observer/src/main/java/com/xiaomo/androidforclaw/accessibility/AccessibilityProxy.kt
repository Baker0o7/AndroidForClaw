 ...
 * - No OpenClaw counterpart (Android platform only)
 */
...
object AccessibilityProxy {
    ...
    /** Call from anywhere to refresh permission status (called after PermissionActivity authorization) */
    ...
    /**
     * Async check if service is ready
     */
    ...
    /**
     * Sync check if service is ready
     */
