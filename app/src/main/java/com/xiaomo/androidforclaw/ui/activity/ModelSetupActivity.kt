 ...
 * Advanced: tap "使用其他Provider" to switch to Anthropic/OpenAI/Custom.
 */
class ModelSetupActivity : AppCompatActivity() {
    ...
    private fun setupAdvancedToggle() {
        binding.tvAdvanced.setOnClickListener {
            ...
            binding.tvAdvanced.text = if (advancedExpanded) {
                ...
                "⚙️ Use Other Providers (Xiaomi MiMo / Google / Anthropic / OpenAI / Custom)"
            }
    ...
    private fun applyProviderPreset(providerKey: String) {
        ...
        binding.apply {
            ...
            (tilApiKey as? com.google.android.material.textfield.TextInputLayout)?.helperText = when (providerKey) {
                ...
                "nvidia" -> "Starts with nvapi-, get it at build.nvidia.com"
                else -> null
            }
    ...
    private fun setupButtons() {
        binding.btnSkip.setOnClickListener {
            Log.i(TAG, "User skipped model setup guide, using default config")
    ...
    private fun saveAndFinish() {
        ...
        try {
            ...
            if (!saved) {
                Toast.makeText(this, "Save failed: Cannot write config file, please check storage permission", Toast.LENGTH_LONG).show()
                return
            }
