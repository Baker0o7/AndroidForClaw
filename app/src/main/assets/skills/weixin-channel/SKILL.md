---
name: weixin-channel
description: WeChat channel plugin. AndroidForClaw supports WeChat messaging (based on WeChat iLink AI interface). Triggered when user mentions WeChat, WeChat plugin, WeChat channel, WeChat login, or WeChat messages.
---
