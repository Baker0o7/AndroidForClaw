 ...
 *
 * Expose PhoneForClaw's own page navigation features, allowing AI Agent to:
...
class NavigationSkill(private val context: Context) : Skill {
    companion object {
        ...
        object Pages {
            ...
            const val CHAT_LOG = "chat_log"            // Chat log
    ...
    override val description = """
        Navigate to various pages within PhoneForClaw app.

        Available pages:
        - main: Main page
        - config: Configuration page (API, model settings)
        - permissions: Permission management page
        - chat_history: Chat history records
        - chat_log: Detailed chat log
        - feishu: Feishu channel configuration
